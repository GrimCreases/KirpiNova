...
export const defaultPreferences: AppPreferences = { displayName: "Yunus", workspaceName: "Personal workspace", geminiApiKey: "", remindersEnabled: true, reminderHour: "09:00", weekStartsMonday: true };
