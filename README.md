...
See [RUN_LOCALLY.md](./RUN_LOCALLY.md) for Windows setup, [COOLIFY_DEPLOYMENT.md](./COOLIFY_DEPLOYMENT.md) for production deployment, and [SECURITY.md](./SECURITY.md) for the security model and go-live checklist.
